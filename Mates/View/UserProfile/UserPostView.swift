...
/**
 * This view displays all the post when we view other users profile page.
 */
...
struct UserPostView: View {
    ...
    @Binding var post: UserProfilePostModel
    let user: UserModel
...
struct UserPostView_Previews: PreviewProvider {
    struct PreviewWrapper: View {
        ...
        @State var samplePost = UserProfilePostModel(
            id: "1251625176",
            mediaUrls: nil,
        ...
        var body: some View {
            UserPostView(post: $samplePost, user: sampleUser)
        }
    }
