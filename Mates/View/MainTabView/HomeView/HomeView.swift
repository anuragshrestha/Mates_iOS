...
struct HomeView: View {
    ...
    let posts: [Post] = [
        Post(name: "Ethan Carter", avatar: "ethan", time: "1d", text: "I'm looking for a study group for my Calculus class. Anyone interested?", imageName: nil, likes: 23, comments: 5, shares: 2),
        ...
        Post(name: "Ethan Harper", avatar: "ethan2", time: "2d", text: "Anyone else feel like the dining hall food has been extra bland lately? I swear, they’ve been skimping on the seasoning. #CollegeLife #FoodieProblems", imageName: nil, likes: 23, comments: 12, shares: 5),
